...
import com.xinglongjian.bigdata.recommender.movie.model.Movie;

/**
 * import movies.dat data to mysql database
 * @author root
 *
 */
public class ImportMovies {
	...
	public static void main(String[] args) {
		try {
			...
			ClassLoader cl=im.getClass().getClassLoader();
			LineNumberReader lineReader = new LineNumberReader(new FileReader(cl.getResource("movies/ml-1m/movies.dat").getFile()));
			String line = "";
